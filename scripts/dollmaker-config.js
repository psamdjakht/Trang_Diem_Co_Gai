...
window.DOLLMAKER_CONFIG = Object.freeze({
  ...
  snapRules: Object.freeze([
    ...
    Object.freeze({ name: "Bra", match: /\/2Tops\/Bra\s/i, x: 108, y: 112 }),
    Object.freeze({ name: "T-shirt", match: /\/2Tops\/T-Shirt\s/i, x: 101, y: 112 }),
    ...
    Object.freeze({ name: "Dress", match: /\/4Full-body\/Dress\s/i, x: 100, y: 112 }),
