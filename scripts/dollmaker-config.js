...
window.DOLLMAKER_CONFIG = Object.freeze({
  ...
  snapRules: Object.freeze([
    ...
    Object.freeze({ name: "Bra", match: /\/2Tops\/Bra\s/i, x: 108, y: 137 }),
    Object.freeze({ name: "T-shirt", match: /\/2Tops\/T-Shirt\s/i, x: 101, y: 133 }),
    Object.freeze({ name: "Panties", match: /\/3Bottoms\/Panties\s/i, x: 105, y: 218 }),
    Object.freeze({ name: "Skirt", match: /\/3Bottoms\/Skirt\s/i, x: 103, y: 205 }),
    Object.freeze({ name: "Dress", match: /\/4Full-body\/Dress\s/i, x: 100, y: 134 }),
